export enum AnamEvent {
  ...
  TOOL_CALL_STARTED_EVENT_RECEIVED = 'TOOL_CALL_STARTED_EVENT_RECEIVED',
  TOOL_CALL_COMPLETED_EVENT_RECEIVED = 'TOOL_CALL_COMPLETED_EVENT_RECEIVED',
  TOOL_CALL_FAILED_EVENT_RECEIVED = 'TOOL_CALL_FAILED_EVENT_RECEIVED',
