...
void main() {
  ...
  // alpha by a code value. The engine has already applied the canonical matte
  // feather, so the client only clears the decoded-video black pedestal and
  // clamps that invalid premultiplied state.
